...
/* 		url = ajax_path + "?function=DealnewsParse&dealSource=" + deal_source + "&source=" + encodeURIComponent(file_source); */
		url = "ajax/ajax.php?function=Parse&dealSource=" + deal_source + "&source=" + encodeURIComponent(file_source);
		$.ajax({
			url: url,
			type: "GET",
			dataType: "json",
...
// Uses ajax call to ajax.php?function=CopyImage&url=[remote img source]&filename=[path/to/hosted/image]
	...
	console.log("path (imagespath + basename): " + path);
		...
		url = "ajax/ajax.php?function=CopyImage&url=" + encodeURIComponent(url) + "&path=" + encodeURIComponent(path);
	$.ajax({
		url: url,
		type: "GET",
		dataType: "json",
...
// Use ajax to get the endpoint, then write it into id elementId 
	...
	$.ajax({
		url: "ajax/ajax.php?function=findEndpoint&url=" + link + "&i=" + elementId,
		type: "GET",
		dataType: "json",
		contentType: 'application/json',
		success: function(data){
