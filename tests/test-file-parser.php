	...
	public function setUp() {
		...
		************/
		...
		foreach($this->rmnContent as $item) {
			$htmlString .= "<ul><li class='offer'>";
			$htmlString .= "<div class='title'><div class='type_icon'></div><h3>" . $item['title'] . "</h3></div>";
			$htmlString .= "<p class='discount'>" . $item['description'] . "</p></li></ul>";
		}
